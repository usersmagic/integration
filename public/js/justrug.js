// This file is created for connections comming from justrug.com
...
// Type: Immediate product suggestions after filter questions are answered
...
function usersmagic() {
  ...
  const DEFAULT_MAX_QUESTION_COUNT = 999999;
  const DEFAULT_START_FUNCTION_DELAY_IN_MS = 0;

  const JUSTRUG_RECOMMENDED_PRODUCT_REDIRECTION_LINKS = [
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-trellis-lattice-modern-collection-yellow-gold-jr1181',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3AYellow+-+Gold&pf_t_color=Color%3ARed&pf_t_color=Color%3AOrange&pf_t_color=Color%3APink&pf_t_style=Style%3AAbstract&pf_t_style=Style%3ABohemian&pf_t_style=Style%3ABrushed&pf_t_style=Style%3AChevron&pf_t_style=Style%3AGeometric&pf_t_style=Style%3AModern&pf_t_style=Style%3APiano&pf_t_style=Style%3AStriped&pf_t_style=Style%3ATrellis+-+Lattice'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-stripe-modern-collection-blue-jr941',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3ABlue&pf_t_color=Color%3AGreen&pf_t_color=Color%3APurple&pf_t_style=Style%3AAbstract&pf_t_style=Style%3ABohemian&pf_t_style=Style%3ABrushed&pf_t_style=Style%3AChevron&pf_t_style=Style%3AGeometric&pf_t_style=Style%3AModern&pf_t_style=Style%3APiano&pf_t_style=Style%3AStriped&pf_t_style=Style%3ATrellis+-+Lattice'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-trellis-lattice-modern-collection-cream-beige-jr935',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3ACream+-+Beige&pf_t_color=Color%3AGray+-+Anthracite&pf_t_color=Color%3ABronze+-+Brown&pf_t_style=Style%3AAbstract&pf_t_style=Style%3ABohemian&pf_t_style=Style%3ABrushed&pf_t_style=Style%3AChevron&pf_t_style=Style%3AGeometric&pf_t_style=Style%3AModern&pf_t_style=Style%3APiano&pf_t_style=Style%3AStriped&pf_t_style=Style%3ATrellis+-+Lattice'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-braided-tassel-collection-red-jr5077',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3AMulticolor&pf_t_style=Style%3AAbstract&pf_t_style=Style%3ABohemian&pf_t_style=Style%3ABrushed&pf_t_style=Style%3AChevron&pf_t_style=Style%3AGeometric&pf_t_style=Style%3AModern&pf_t_style=Style%3APiano&pf_t_style=Style%3AStriped&pf_t_style=Style%3ATrellis+-+Lattice'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-braided-tassel-collection-gray-anthracite-jr5106',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3ABlack&pf_t_style=Style%3AAbstract&pf_t_style=Style%3ABohemian&pf_t_style=Style%3ABrushed&pf_t_style=Style%3AChevron&pf_t_style=Style%3AGeometric&pf_t_style=Style%3AModern&pf_t_style=Style%3APiano&pf_t_style=Style%3AStriped&pf_t_style=Style%3ATrellis+-+Lattice'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-tribal-ethnic-collection-yellow-gold-jr1665',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3AYellow+-+Gold&pf_t_color=Color%3ARed&pf_t_color=Color%3AOrange&pf_t_color=Color%3APink&pf_t_style=Style%3AErased&pf_t_style=Style%3ATraditional&pf_t_style=Style%3AFloral&pf_t_style=Style%3AMedallion&pf_t_style=Style%3AOriental&pf_t_style=Style%3APatchwork&pf_t_style=Style%3APersian&pf_t_style=Style%3AVintage&pf_t_style=Style%3ATribal+-+Ethnic'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-oriental-collection-blue-green-jr162',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3ABlue&pf_t_color=Color%3AGreen&pf_t_color=Color%3APurple&pf_t_style=Style%3AErased&pf_t_style=Style%3ATraditional&pf_t_style=Style%3AFloral&pf_t_style=Style%3AMedallion&pf_t_style=Style%3AOriental&pf_t_style=Style%3APatchwork&pf_t_style=Style%3APersian&pf_t_style=Style%3AVintage&pf_t_style=Style%3ATribal+-+Ethnic'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-medallion-persian-collection-yellow-gold-cream-beige-jr1930',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3ACream+-+Beige&pf_t_color=Color%3AGray+-+Anthracite&pf_t_color=Color%3ABronze+-+Brown&pf_t_style=Style%3AErased&pf_t_style=Style%3ATraditional&pf_t_style=Style%3AFloral&pf_t_style=Style%3AMedallion&pf_t_style=Style%3AOriental&pf_t_style=Style%3APatchwork&pf_t_style=Style%3APersian&pf_t_style=Style%3AVintage&pf_t_style=Style%3ATribal+-+Ethnic'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-floral-patchwork-collection-multicolor-jr1958',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3AMulticolor&pf_t_style=Style%3AErased&pf_t_style=Style%3ATraditional&pf_t_style=Style%3AFloral&pf_t_style=Style%3AMedallion&pf_t_style=Style%3AOriental&pf_t_style=Style%3APatchwork&pf_t_style=Style%3APersian&pf_t_style=Style%3AVintage&pf_t_style=Style%3ATribal+-+Ethnic'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-braided-tassel-collection-red-black-jr5063',
      redirect: 'https://www.justrug.com/collections/usso-washable-rugs?pf_t_color=Color%3ABlack&pf_t_style=Style%3AErased&pf_t_style=Style%3ATraditional&pf_t_style=Style%3AFloral&pf_t_style=Style%3AMedallion&pf_t_style=Style%3AOriental&pf_t_style=Style%3APatchwork&pf_t_style=Style%3APersian&pf_t_style=Style%3AVintage&pf_t_style=Style%3ATribal+-+Ethnic'
    },
    {
      url: 'https://www.justrug.com/products/machine-washable-area-rug-tone-on-tone-ombre-collection-tone-on-tone-ombre-yellow-gold-jr1302',
      ...
      checkQuestion(res => {
        ...
        document.addEventListener('click', event => {
          ...
          if (event.target.classList.contains('usersmagic-close-button') || event.target.parentNode.classList.contains('usersmagic-close-button')) {
            document.querySelector('.usersmagic-content-clicker-wrapper').style.transform = 'translateX(calc(100% - 40px))';
            isPopupOn = false;
        ...
        getEmail((err, res) => {
          ...
          askQuestion(0, (err, count) => {
            if (err) return throwError(err);

            getBanner((err, res) => {
              if (err || !res) return endContent(count);
    
              // Create banner, a new banner appeared after questions are answered
              createContent({
                type: 'banner'
              }, err => {
                if (err) return callback(err);
    
                return endContent(count);
              });
            });
          });
        });
  ...
  createChoice = function(choice, wrapper, wrapperWidth) {
    ...
    eachChoiceWrapper.style.width = ((wrapperWidth - 60) * 0.33) + 'px';
    ...
    if (wrapper.childNodes.length) {
      const lastChoiceWrapperLine = wrapper.childNodes[wrapper.childNodes.length-1];

      if (lastChoiceWrapperLine.childNodes.length < 3) {
        eachChoiceWrapper.style.marginLeft = '8px';
        lastChoiceWrapperLine.appendChild(eachChoiceWrapper);
      } else {
        const eachChoiceWrapperLine = document.createElement('div');
        eachChoiceWrapperLine.classList.add('usersmagic');
        eachChoiceWrapperLine.classList.add('usersmagic-each-choice-wrapper-line');

        eachChoiceWrapperLine.appendChild(eachChoiceWrapper);
        wrapper.appendChild(eachChoiceWrapperLine);
      }
    } else {
      const eachChoiceWrapperLine = document.createElement('div');
      eachChoiceWrapperLine.classList.add('usersmagic');
  ...
  createContent = function(data, callback) {
    if (contentClickerWrapper && contentOuterWrapper) {
      ...
      if (data.type == 'email') {
        ...
        usersmagicEmailInputWrapper.classList.add('usersmagic-line');
        ...
        usersmagicInput.placeholder = 'Your email address';
        usersmagicEmailInputWrapper.appendChild(usersmagicInput);

        const usersmagicButton = document.createElement('span');
        usersmagicButton.classList.add('usersmagic');
        usersmagicButton.classList.add('usersmagic-text-button');
        usersmagicButton.id = 'usersmagic-approve-email-button';
        usersmagicButton.innerHTML = 'Start';
        ...
        const usersmagicCheckBoxSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        usersmagicCheckBoxSVG.classList.add('usersmagic');
        usersmagicCheckBoxSVG.setAttributeNS(null, 'width', '14');
        usersmagicCheckBoxSVG.setAttributeNS(null, 'height', '11');
        usersmagicCheckBoxSVG.setAttributeNS(null, 'viewBox', '0 0 14 11');
        usersmagicCheckBoxSVG.setAttributeNS(null, 'fill', 'none');

        const usersmagicCheckBoxSVGPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        usersmagicCheckBoxSVGPath.classList.add('usersmagic');
        usersmagicCheckBoxSVGPath.setAttributeNS(null, 'd', 'M5.05469 9.8125C5.28906 10.0469 5.6875 10.0469 5.92188 9.8125L12.8125 2.92188C13.0469 2.6875 13.0469 2.28906 12.8125 2.05469L11.9688 1.21094C11.7344 0.976562 11.3594 0.976562 11.125 1.21094L5.5 6.83594L2.85156 4.21094C2.61719 3.97656 2.24219 3.97656 2.00781 4.21094L1.16406 5.05469C0.929688 5.28906 0.929688 5.6875 1.16406 5.92188L5.05469 9.8125Z');
        usersmagicCheckBoxSVGPath.setAttributeNS(null, 'fill', '#FEFEFE');
        usersmagicCheckBoxSVG.appendChild(usersmagicCheckBoxSVGPath);

        usersmagicCheckBox.appendChild(usersmagicCheckBoxSVG);
        ...
        span1.innerHTML = 'By checking the box, I accept';
        ...
        document.addEventListener('click', function listenForEmailInput(event) {
          if (event.target.classList.contains('usersmagic-check-box-wrapper') || ( event.target.parentNode &&  (event.target.parentNode.classList.contains('usersmagic-check-box-wrapper') || (event.target.parentNode.parentNode && (event.target.parentNode.parentNode.classList.contains('usersmagic-check-box-wrapper') || event.target.parentNode.parentNode.parentNode && event.target.parentNode.parentNode.parentNode.classList.contains('usersmagic-check-box-wrapper')))))) {
            if (isCheckboxChecked) {
              usersmagicCheckBox.style.backgroundColor = 'rgb(254, 254, 254)';
              usersmagicCheckBox.style.borderWidth = '1px';
            } else {
              usersmagicCheckBox.style.backgroundColor = 'rgb(159, 199, 170)';
              usersmagicCheckBox.style.borderWidth = '0px';
            }
        ...
        if (question.subtype == 'yes_no' || question.subtype == 'single' || question.subtype == 'multiple' || question.subtype == 'time') {
          ...
          for (let i = 0; i < question.choices.length; i++)
            createChoice(question.choices[i], choicesWrapper, Math.max(Math.min(0.94 * vw, 350), 0.33 * vw));
          ...
          usersmagicListInput.placeholder = 'Type to search';
        ...
        usersmagicTitle.classList.add('usersmagic');
        usersmagicTitle.classList.add('usersmagic-title');
        usersmagicTitle.innerHTML = 'Your Suggestions';
        ...
        bannerButton.style.width = '150px';
        ...
        if (product && product.redirect) {
          const bannerShowMoreButton = document.createElement('a');
          bannerShowMoreButton.classList.add('usersmagic');
          bannerShowMoreButton.classList.add('usersmagic-show-more-button');
          bannerShowMoreButton.innerHTML = 'See More Options';
          bannerShowMoreButton.href = product.redirect;
          bannerShowMoreButton.target = '_blank';
          contentInnerWrapper.appendChild(bannerShowMoreButton);
        }

        const bannerRestartButton = document.createElement('span');
        bannerRestartButton.classList.add('usersmagic');
        bannerRestartButton.classList.add('usersmagic-restart-button');
        bannerRestartButton.innerHTML = 'Try Again';
        bannerRestartButton.id = 'usersmagic-restart-button';
        contentInnerWrapper.appendChild(bannerRestartButton);
        ...
        document.addEventListener('click', event => {
          ...
          if (event.target.id == 'usersmagic-restart-button') {
            serverRequest('/question/delete?email=' + email, 'POST', {
              path
            }, res => {
              if (!res.success)
      ...
      if (isMobile())
        contentClickerWrapper.style.transform = 'translateX(calc(100% - 40px))';
      ...
      footerSpan.classList.add('usersmagic');
      footerSpan.classList.add('usersmagic-footer-text');
      footerSpan.innerHTML = 'secured by'
      footerWrapper.appendChild(footerSpan);
  ...
  endContent = function(count) {
    ...
    if (contentClickerWrapper)
      contentClickerWrapper.style.display = 'none';
  }
